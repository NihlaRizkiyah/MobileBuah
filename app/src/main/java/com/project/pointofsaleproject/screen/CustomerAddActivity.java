...
public class CustomerAddActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = CustomerAddActivity.this;
    ...
    private void saveData() {
        ...
        mApiRest.saveCustomer(nama, nomor, email, alamat).enqueue(new Callback<JsonObject>() {
            @Override
            public void onResponse(@NonNull Call<JsonObject> call, retrofit2.Response<JsonObject> response) {
                if(response.isSuccessful()) {
                    ...
                    if (response.body() == null) {
                        ...
                        setResult(Activity.RESULT_OK, new Intent().putExtra("data",customer));
                        finish();
